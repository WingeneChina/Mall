...
//        return PersonRcommendItemHolder.build(parent);
//    }
//
//    @Override
//    public void onBindViewHolder(ViewHolder holder, int position) {
//        ((PersonRcommendItemHolder) holder).onBindViewHolder(mProductListBeen, position);
//    }
//
    @Override
    public int getItemCount() {
     ...
     .recommend_person_recommend_item_layout,
                    parent, false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            final RecommendModel.DataBean.SpecialsBean.ProductListBean productListBean = mProductListBeen.get
     (position);
            ...
            if (!TextUtils.isEmpty(productListBean.getAcceptIntegral())) {
                ...
                daySpecialPrice.personRecommendCanDeductible.setText("可抵应币¥" + String.valueOf(productListBean
     .getAcceptIntegral
                        ()));
            } else {
