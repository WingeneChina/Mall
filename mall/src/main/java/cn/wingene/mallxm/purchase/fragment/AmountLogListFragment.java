...
public class AmountLogListFragment extends BasePullListFragment {

    private RechargeScheme mOrderScheme = new RechargeScheme(this);
    boolean hadCreted;

    public static AmountLogListFragment newInstance(int state) {
        AmountLogListFragment productListFragment = new AmountLogListFragment();
    ...
    public static class RechargeScheme extends Scheme<Integer, AmountLog> {
    ...
    private static class OrderItemHolder extends ItemViewHolder<AmountLog> {
        ...
        @Override
        public ItemViewHolder<AmountLog> buildNewSelf(Context context) {
            return new OrderItemHolder(context);
        }

        @Override
        public void display(final int position, AmountLog item) {
